...
Name "Master Games Arcade 1.1.3"
OutFile "..\release-visual-1.1.3\Master Games Arcade Setup 1.1.3-complete.exe"
...
Section "Master Games Arcade" SEC_MAIN
  SetOutPath "$INSTDIR"
  File /r "..\release-visual-1.1.3\win-unpacked\*"
  FileOpen $0 "$INSTDIR\README.txt" w
  FileWrite $0 "Master Games Arcade 1.1.3\r$\n"
  FileWrite $0 "Dev Emerson 2026\r$\n"
  FileWrite $0 "Painel visual de controles testado; status, captura e persistência validados.\r$\n"
...
Function .onInstSuccess
  MessageBox MB_ICONINFORMATION "Instalação concluída. O painel visual foi testado e as configurações continuam salvas automaticamente."
FunctionEnd
